...
| Runbook | Purpose |
| --- | --- |
| [atlassian-mcp-jira-intake.md](atlassian-mcp-jira-intake.md) | Configure and verify read-only JIRA intake through Atlassian MCP with an ephemeral stdio OAuth proxy. |
