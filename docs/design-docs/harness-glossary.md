...
harness generated by `mars init`.
...
### When maintaining MARS source or validating foundation runtime changes include this: `docs/design-docs/foundation-operating-model.md`
