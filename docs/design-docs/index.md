...
| AD-077 | `tool_create` scaffolds built-in tool files and tests while requiring separate implementation, registration, trust-policy review, and allowlist exposure. | dogfood-and-decisions.md | Tools |
