...
| [dogfood-and-decisions.md](dogfood-and-decisions.md) | Accepted | Containerised E2E validation (Podman + native fallback), decision recording tool, strict-trunk pipeline for local use, ticket-drain discipline, recovery loop containment, and queue self-healing. AD-021 through AD-030, AD-033, AD-060, AD-062. |
...
| [release-versioning.md](release-versioning.md) | Accepted | Semantic versioning, generated patch notes, mirrored source/target release behavior, automatic versioning after non-release commits, GitHub Release publication when configured, self-update, and shell PATH setup. AD-049 through AD-051, AD-056 through AD-057, AD-059, AD-068 through AD-070, AD-075. |
