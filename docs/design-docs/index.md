...
| [release-versioning.md](release-versioning.md) | Accepted | Semantic versioning, detailed generated patch notes, mirrored source/target release behavior, automatic versioning after non-release commits, GitHub Release publication when configured, self-update, release assets, and shell PATH setup. AD-049 through AD-051, AD-056 through AD-057, AD-059, AD-068 through AD-070, AD-075, AD-078, AD-099. |
...
| AD-098 | No stale documentation: code changes carry top-of-file `MarsDocSync` metadata listing associated docs, and those docs are updated in the same change or explicitly checked as still current. | delivery-operating-model.md | Documentation discipline |
