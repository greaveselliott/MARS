...
Then the harness initializes if needed, registers the repo, seeds the CEO role, and runs with repo-scoped state
...
- F-006-S005: planned command-level E2E evidence for `start`
