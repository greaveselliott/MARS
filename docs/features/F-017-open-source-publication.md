...
10. Through T-079, commit and configure every private-safe fork/contribution, governance, Issues, Discussions, Dependabot, ruleset, and installed-App control, and prove the public-only bundle in a disposable public hostile-fork rehearsal. CodeQL, secret scanning/push protection, private vulnerability reporting, and Pages cannot be production-enabled on this private personal repository without unavailability or premature publication, so stage them for immediate T-081 post-visibility enablement and verification.
...
F-017-S002 is complete. F-017-S001 and F-017-S003 through F-017-S005 remain incomplete. Primary Status remains `primary_blocked`, repository visibility remains private, and no publication or announcement is authorized.
