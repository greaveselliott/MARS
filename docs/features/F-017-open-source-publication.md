...
- **F-017-S003:** T-064 through T-068 completed the private v0.93 retirement, GoReleaser producer/consumer contract, source compatibility, and unsigned rehearsal. T-077 is current with three bounded checkpoints: anonymous setup/auth plus local-fallback clearing; explicit license/terms acknowledgement before third-party downloads; and an exact-version Go/SumDB bootstrap that delegates archive verification and durable replacement to the existing signed updater. T-077 may establish private implementation and fixture evidence only: automatic Linux llama.cpp acquisition stays disabled, and real official tags, releases, signing, logged-out downloads, update, and rollback remain T-078/T-080/T-081 work. F-017-S003 is not complete.
