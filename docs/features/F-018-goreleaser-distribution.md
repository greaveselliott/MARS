...
- **F-018-S002:** In progress under T-066. A1 is pushed at `fcf7397`: exact `sigstore-go v1.2.2`, the pinned public-good root, one exact GitHub Actions workflow/repository/tag/full-commit identity, transparency proof, observer time, SCT, raw checksum bytes, and the exact eight-entry MARS checksum grammar now verify offline with fixed redacted failures. A pinned GoReleaser `v2.17.0` public checksum/signature vector supplies positive conformance without constituting a MARS signature or release. Exact Go 1.25.12 full-source and vulnerability gates, release Go 1.26.5 vulnerability scanning, focused race, module provenance, DocSync correction, and four cross-builds passed with zero called vulnerabilities. A2 archive safety and checkpoints B through E remain incomplete; no real MARS signing or publication evidence exists.
