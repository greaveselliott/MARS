...
- **F-018-S002:** In progress under T-066 after T-067 passed the source compatibility prerequisite on 2026-07-22. Exact Go 1.25.12 and release Go 1.26.5 gates, real Go 1.25.11 rejection, source-only doctor enforcement, four cross-builds, and installed/fresh-target smoke passed without a Sigstore or publication change. Official `sigstore-go v0.7.0` remains rejected for `GO-2026-5952`; T-066 must now admit exact `v1.2.2`, rerun whole-source/called-path scanning, and implement the signed consumers. No verifier dependency, real MARS signing, or publication evidence exists yet.
