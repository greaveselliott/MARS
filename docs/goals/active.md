...
- Current Evidence: T-055/private v0.68.42 closed the vulnerability baseline; T-056/private v0.68.44 recorded the redacted publication-surface inventory and isolated audit contract; T-057/private v0.68.46 closed the loopback listener and authenticated, authorized, replay-safe GitHub webhook ingress slice. T-058/private v0.68.48 passes QA, Security, full mechanical gates, private release verification, and the installed clean-target HTTP/SQLite dashboard security matrix; its real-browser DOM/network lane remains unconfirmed.
- Current Blocker: Publication authority, name clearance, full restricted-evidence scans, manual privacy/IP review, and runtime/release/contribution cutover gates remain incomplete. T-058 additionally remains the sole current ticket until an available in-app browser proves hostile strings inert in the real DOM and outbound-disabled rendering makes zero external requests.
