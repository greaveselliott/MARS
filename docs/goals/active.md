...
- Current Evidence: T-055/private v0.68.42 closed the vulnerability baseline; T-056/private v0.68.44 recorded the redacted publication-surface inventory and isolated audit contract; T-057/private v0.68.46 closed the loopback listener and authenticated, authorized, replay-safe GitHub webhook ingress slice. The current authorized slice hardens the shipped embedded dashboard browser and control boundary.
- Current Blocker: Publication authority, name clearance, full restricted-evidence scans, manual privacy/IP review, and runtime/release/contribution cutover gates remain incomplete.
