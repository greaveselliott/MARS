...
- Current Blocker: T-066 A1 rejected the Go-1.22-compatible Sigstore verifier, then found zero called vulnerabilities on the exact `sigstore-go v1.2.2` path when built with Go 1.25.12. Moving MARS's source floor from Go 1.22.4 to 1.25.12 requires separate owner approval and a dedicated compatibility ticket; T-067 and the standard history/privacy/IP, runtime, contribution, rehearsal, cutover, and canary gates also remain incomplete. No supported public release exists.
...
- Review Trigger: Any T-066 through T-067 evidence, standard scan finding, owner disposition, F-017 scenario change, private rehearsal, visibility change, cutover smoke, or canary incident.
