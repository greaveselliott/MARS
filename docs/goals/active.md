...
- Current Blocker: T-066 A1 rejected the newest Go-1.22-compatible Sigstore verifier because exact called-path scanning found 14 vulnerabilities, including the direct `GO-2026-5952` verification-threshold bypass; its fixed upstream release requires a separately approved minimum-Go migration. T-067 and the standard history/privacy/IP, runtime, contribution, rehearsal, cutover, and canary gates also remain incomplete. No supported public release exists.
