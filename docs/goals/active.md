...
- Current Ticket: T-078, blocked on hosted-state closure of the approved standard path. Exact source `d411cbe` supplies the dormant least-privilege Go/archive/Syft/GitHub-attestation workflow and compatible consumer and passes the two-clean-root no-publish rehearsal. The current hosted-state seal and any separately authorized sanitation/future-only immutable-Release transaction remain. No launch tag, real attestation, upload, Release, visibility change, announcement, hosted deletion, or immutable-Release setting change is currently authorized.
- Current Checkpoint Evidence: T-077 is complete through exact pushed commits `10b62f7d59620022b2e1030c5f33856d0c16e70f`, `04d6ba6844126dc84eb6bedc13c78bd31f8d371d`, `85c689c70ef801a2747acabf537739c9ebad3c12`, and closure source `56b8de336cf4d1439944cc7eb8ea0f5ad4043f2b`. T-078's rejected GoReleaser/Cosign/containment route and verifier evidence are preserved as a local non-authorizing checkpoint. Exact pushed source `d411cbe` replaces that route with the dormant AD-315 workflow, standard attestation consumer, Go 1.27 producer contract, zero-called vulnerability baseline, and a passed two-clean-root no-publish rehearsal. Four archives were byte-identical, normalized SBOM semantics matched, native identity and the public official attestation fixture passed, and no real bundle or hosted mutation occurred. The oldest 401 live workflow-run IDs reproduced T-072's seal; the exact 65-run delta at 466 completed and zero active runs was acquired and scan-clean. The blocked history remains in `docs/validation/reports/2026-08-24-t078-release-production-admission-blocked.md`; rehearsal evidence is in `docs/validation/reports/2026-08-24-t078-conventional-no-publish-rehearsal.md`; every later hosted run remains in scope before deletion.
- Current Blocker: The current hosted seal, sanitation/future-only immutable-Release authority, contribution controls, separately approved visibility change, two real attested releases, and canary remain. Primary Status is `primary_blocked`.
