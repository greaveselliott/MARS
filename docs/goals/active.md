...
- Current Ticket: T-078, blocked on hosted-CI closure of the standard path and separately re-approving the revised sanitation transaction after deployment-state drift. Exact source `d411cbe` supplies the dormant least-privilege Go/archive/Syft/GitHub-attestation workflow and compatible consumer and passes the two-clean-root no-publish rehearsal. On 2026-08-25 the owner approved the bounded Go 1.25.13 source-floor remediation without a vulnerability exception. No launch tag, real attestation, upload, Release, visibility change, announcement, or publication is authorized.
- Current Checkpoint Evidence: T-077 is complete through exact pushed commits `10b62f7d59620022b2e1030c5f33856d0c16e70f`, `04d6ba6844126dc84eb6bedc13c78bd31f8d371d`, `85c689c70ef801a2747acabf537739c9ebad3c12`, and closure source `56b8de336cf4d1439944cc7eb8ea0f5ad4043f2b`. T-078's rejected GoReleaser/Cosign/containment route and verifier evidence are preserved as a local non-authorizing checkpoint. Exact pushed source `d411cbe` replaces that route with the dormant AD-315 workflow, standard attestation consumer, Go 1.27 producer contract, zero-called vulnerability baseline, and a passed two-clean-root no-publish rehearsal. Immediate pre-mutation revalidation on 2026-08-25 found deployments had independently moved from 77 to zero, so MARS stopped before mutation; current read-only evidence binds 301 tags, the intended 56 Releases, 500 assets, 474 completed runs, zero deployments, zero Actions artifacts/caches, and disabled immutable Releases. Exact Go 1.25.13 local normal/vet/build/race and govulncheck v1.7.0 gates pass with zero called findings, and exact Go 1.25.12 is rejected at the new module floor. Hosted proof remains pending. Evidence is in `docs/validation/reports/2026-08-24-t078-hosted-state-revalidation.md`.
