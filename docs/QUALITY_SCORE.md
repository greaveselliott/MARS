...
| Ticket flow and intervention debt | A | 0 backlog, 0 in-progress, 59 done, 0 open intervention-debt | Drain in-progress and high-priority intervention debt before ordinary backlog work; keep medium/low intervention debt visible without blocking product progress. |
...
| Intervention debt | 0 open intervention-debt, 22 total intervention-debt |
