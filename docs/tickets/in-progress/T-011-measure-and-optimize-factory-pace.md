...
- Rerun the API canary to confirm DocSync failures cannot be approved and
  policy-blocked timeout wrappers no longer enqueue duplicate Dogfood work.
