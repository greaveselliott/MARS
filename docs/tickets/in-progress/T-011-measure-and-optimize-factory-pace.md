...
- Rerun the API canary to confirm scratch-validation and timeout rejection keep
  Engineer out of root-script pollution before claiming the optimization
  improved the live factory.
