---
id: MH-028
title: mars doctor comprehensive health check with remediation hints
priority: medium
complexity: small
...
# MH-028: `mars doctor` — GPU, models, inference, GitHub, webhook, DB, disk, scores
...
- Each finding includes `remediation` array of concrete shell commands (`mars setup --step github`, etc.)
