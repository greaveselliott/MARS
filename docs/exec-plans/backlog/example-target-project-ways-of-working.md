# Backlog P0 Exec Plan: Example Target Project Ways Of Working
...
**Hypothesis:** A default-off integrations layer can let MARS adopt Example Target Project's JIRA-board-driven workflow while preserving the current CEO-led/GitHub/trunk path for every repo that does not opt in.
...
**Source:** Operator-approved Example Target Project Ways Of Working program executed by Codex with MARS role subagents.

## Primary Outcome

Add an optional board-driven Example Target Project-compatible workflow to MARS:
