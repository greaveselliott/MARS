...
**Current Ticket:** None — T-079 is complete; T-078 cleanup remains separately approval-gated
...
**Current Failing Scenario:** F-017-S003/F-017-S004 — T-079's private source and hosted settings pass through final source `3502110` and hosted run `32903803262`: community files, DCO/CODEOWNERS, fork-safe CI, authenticated Dependabot handling, Discussions, and exact ruleset `21491158` are active without changing visibility. The public-only security bundle and genuine hostile-fork smoke remain T-080 work after visibility, while T-078's exact cleanup/future-only immutable-Release transaction remains separately approval-gated.
...
- **Current Primary Blocker:** The separately approval-gated T-078 cleanup remains parked; public-only controls, visibility, launch attestations, releases, and announcement remain later gates.
- **Next Primary Action:** Re-present and, only after exact separate approval, revalidate T-078's hosted cleanup/future-only immutable-Release transaction before T-080. Do not change visibility, Releases, tags, Pages, Apps, or publication state without their owning approvals.
