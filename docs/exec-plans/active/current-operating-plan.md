...
- `v0.36.4`, `v0.36.5`, `v0.36.6`, `v0.37.0`, `v0.38.0`, and `v0.39.0` release
  notes and tags were pushed on 2026-05-19, but CI and Release workflow jobs
  were not started because GitHub reported recent account payment failure or a
  spending-limit increase requirement.
  `mars-harness release verify-assets --version v0.39.0` is blocked because the
