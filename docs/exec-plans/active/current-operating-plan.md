...
- `v0.36.4`, `v0.36.5`, `v0.36.6`, `v0.37.0`, `v0.38.0`, `v0.39.0`,
  ...
  `v0.41.15`, `v0.41.16`, `v0.41.17`, `v0.41.18`, `v0.41.19`, and `v0.41.20` release notes and tags were pushed on
  ...
  requirement.
  Notes-only GitHub Releases for `v0.36.4` through `v0.41.20` were created from
  ...
  v0.41.20` is still blocked because the `v0.41.20` release is missing
  `mars-harness-linux-amd64`, `mars-harness-linux-arm64`,
  `mars-harness-darwin-amd64`, `mars-harness-darwin-arm64`, and
  `checksums.txt`; GitHub Actions run `26127529878` failed with "recent account
  payments have failed or your spending limit needs to be increased" before
  assets could be built. `v0.41.16`, `v0.41.17`, `v0.41.18`, and `v0.41.19`
  have the same missing-asset blocker via runs `26126035892`, `26126035944`,
  `26126461151`, and `26127153189`.
...
| F-009-S013 | Passing | `go test ./internal/docsconsistency ./internal/docsync` and `gh release view v0.41.20 --repo greaveselliott/mars-harness` cover the release-object gate and notes-only fallback. `mars-harness release verify-assets --version v0.41.20` records the separate missing-asset blocker. |
