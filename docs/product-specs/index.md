...
Start with [vision.md](vision.md), then [product-surface.md](product-surface.md). Use [mars-relationship.md](mars-relationship.md) when evaluating parity with Mars. Use [spec-maintenance.md](spec-maintenance.md) when changing the product contract.
