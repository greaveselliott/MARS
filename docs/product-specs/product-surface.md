...
| `mars-harness validation check-closure --report <path>` | Implemented | Checks source-owned validation closure reports for honest pass/fail-table and closure-verdict consistency. It is a foundation-maintainer evidence gate and does not replace clean-project factory replays. |
