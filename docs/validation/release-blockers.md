...
- `v0.21.0` release notes and tag were pushed on 2026-05-03, but
  `mars release verify-assets --version v0.21.0` is blocked because
...
- `v0.23.0` release notes and tag were pushed on 2026-05-03 for `MH-047`, but
  `go run ./cmd/mars release verify-assets --version v0.23.0` is
...
- `v0.36.4`, `v0.36.5`, `v0.36.6`, `v0.37.0`, `v0.38.0`, `v0.39.0`,
  ...
  longer stale at `v0.36.3`. `mars release verify-assets --version
...
- `v0.41.28` release notes and tag were pushed on 2026-05-19 for `T-011`, but
  `mars release verify-assets --version v0.41.28` is blocked because
...
- `v0.41.29` release notes and tag were pushed on 2026-05-19 for the
  Homebrew/install-doc correction, but `mars release verify-assets
  --version v0.41.29` is blocked because the notes-only GitHub Release is
  missing `mars-linux-amd64`, `mars-linux-arm64`,
  `mars-darwin-amd64`, `mars-darwin-arm64`, and
...
- `v0.41.30` release notes and tag were pushed on 2026-05-19 for the
  ...
  created from the generated changelog entry. `mars release
...
- `v0.41.31` release notes and tag were pushed on 2026-05-20 for the
  ...
  `mars release verify-assets --version v0.41.31` is blocked because
  the notes-only release is missing `mars-linux-amd64`,
  `mars-linux-arm64`, `mars-darwin-amd64`,
  `mars-darwin-arm64`, and `checksums.txt`. Main-branch CI run
...
- `v0.41.32` release notes and tag were pushed on 2026-05-20 for the
  ...
  changelog entry. `mars release verify-assets --version v0.41.32` is
  blocked because the notes-only release is missing `mars-linux-amd64`,
  `mars-linux-arm64`, `mars-darwin-amd64`,
  `mars-darwin-arm64`, and `checksums.txt`. Main-branch CI runs
...
- `v0.41.33` release notes and tag were pushed on 2026-05-20 for generic
  ...
  from the generated changelog entry. `mars release verify-assets
...
- `v0.41.34` release notes and tag were pushed on 2026-05-20 for deployed
  ...
  workflow run `26159792017` failed before asset publication. `mars
  release verify-assets --version v0.41.34` is blocked because the notes-only
  release is missing `mars-linux-amd64`, `mars-linux-arm64`,
  `mars-darwin-amd64`, `mars-darwin-arm64`, and
...
- `v0.42.0` release notes and tag were pushed on 2026-05-20 for Factory Pace
  ...
  `26160517742` failed before asset publication. `mars release
...
- `v0.42.1` release notes and tag were pushed on 2026-05-20 for scheduler
  ...
  `26161635964` failed before asset publication. `mars release
...
- `v0.42.2` release notes and tag were pushed on 2026-05-20 for bounded
  ...
  workflow run `26162728208` failed before asset publication. `mars
...
- `v0.42.3` release notes and tag were pushed on 2026-05-20 for canonical
  ...
  workflow run `26163661221` failed before asset publication. `mars
...
- `v0.42.4` release notes and tag were pushed on 2026-05-20 for module-named
  ...
  `26165154660` failed before asset publication. `mars release
...
- `v0.42.5` release notes and tag were pushed on 2026-05-20 for generated
  ...
  `26166239400` failed before asset publication. `mars release
...
- `v0.42.6` release notes and tag were pushed on 2026-05-20 for managed server
  ...
  `26170992204` failed before asset publication. `mars release
...
- `v0.42.7` release notes and tag were pushed on 2026-05-20 for repo-local
  ...
  `26172375090` failed before asset publication. `mars release
...
- `v0.42.8` release notes and tag were pushed on 2026-05-20 for bare port
  ...
  `26173478220` failed before asset publication. `mars release
...
- `v0.42.9` release notes and tag were pushed on 2026-05-20 for scratch
  ...
  `26174999000` failed before asset publication. `mars release
...
- `v0.42.10` release notes and tag were pushed on 2026-05-20 for background
  ...
  `26176025806` failed before asset publication. `mars release
...
- `v0.42.11` release notes and tag were pushed on 2026-05-20 for implicit Go
  ...
  `26177399129` failed before asset publication. `mars release
...
- `v0.42.12` release notes and tag were pushed on 2026-05-20 for tracked
  ...
  `26178462481` failed before asset publication. `mars release
...
- `v0.42.13` release notes and tag were pushed on 2026-05-20 for no-op
  ...
  `26179799379` failed before asset publication. `mars release
...
- `v0.42.14` release notes and tag were pushed on 2026-05-20 for DocSync
  ...
  before asset publication. `mars release verify-assets --version
...
- `v0.42.15` release notes and tag were pushed on 2026-05-20 for the
  ...
  hosted runners with the account billing/spending-limit blocker. `mars
...
- `v0.42.16` release notes and tag were pushed on 2026-05-20 for the dashboard
  ...
  GitHub. `mars release verify-assets --version v0.42.16` is blocked
...
- `v0.42.17` release notes and tag were pushed on 2026-05-21 for the
  ...
  `https://github.com/greaveselliott/MARS/releases/tag/v0.42.17`.
  ...
  `go run ./cmd/mars release verify-assets --version v0.42.17` is
...
- `v0.42.18` release notes and tag were pushed on 2026-05-21 for the
  ...
  `77250600906` and CI job `77250569043`. `go run ./cmd/mars release
...
- `v0.42.19` release notes and tag were pushed on 2026-05-21 for the
  ...
  passed, publishing `mars-linux-amd64`, `mars-linux-arm64`,
  `mars-darwin-amd64`, `mars-darwin-arm64`, and
  `checksums.txt`. `go run ./cmd/mars release verify-assets --version
  v0.42.19` passed against
  `https://github.com/greaveselliott/MARS/releases/tag/v0.42.19`.
...
- `v0.45.1`: the first live `mars release audit --repo . --limit 5`
  ...
  `v0.45.1` release-note commit on `main`, then run `mars release
