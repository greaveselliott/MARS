...
10. **Source improvements need live-experience checks.** When changing Mars Harness lifecycle, orchestration, generated target scaffolding, intervention-debt routing, model/provider behavior, dashboard/control-plane behavior, scoring, safety/guardrails, or update/release behavior, verify the improvement against a representative live target such as `demo-123`, or record the exact blocker and replay steps.
