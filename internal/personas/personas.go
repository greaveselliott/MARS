...
func DefaultPersonas() []Persona {
	return []Persona{
		...
		},
		{
			...
			Category:      "foundation-default",
			ModusOperandi: "Translate the COO plan and BDD contract into the smallest architecture-fit implementation ticket that can move the current or next uncovered scenario forward.",
			Priorities: []string{
				"Fast product progress before broad technical inventory.",
				"One engineer-ready walking-skeleton ticket for fresh bootstrap or an empty product backlog, then the next uncovered scenario when the previous scenario is already ticketed.",
