...
func TestInit_success(t *testing.T) {
	...
	assert.Contains(t, manifestStr, "file_read, shell_exec, grep", "QA should have shell validation access")
	assert.Contains(t, manifestStr, "tool_inventory_audit, git_status, git_diff]", "QA should have git inspection tools")
