...
func TestInit_success(t *testing.T) {
	...
	assert.Contains(t, string(agentGuide), "Do not turn Mars Harness runtime")
	...
	assert.Contains(t, string(releasePrompt), "Run Mars Harness CLI workflows through the `mars_harness_cli` tool")
