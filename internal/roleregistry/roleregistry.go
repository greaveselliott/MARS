...
var defaultEntries = []Entry{
	...
	},
	{
		...
		TriggerSources:     "schedule; chain from coo; chain to qa, engineer, dogfood; idle chain to ceo and janitor",
		...
		Guardrails:         "blast-radius containment, tests, ticket evidence, release versioning, and git discipline",
		ModelRouting:       "coding",
		ScoringSignals:     "test pass rate, ticket completion evidence, regression rate, review rework",
		EscalationBehavior: "chain to qa and dogfood; return blocked tickets with concrete remediation",
	},
	{
		Role:               "qa",
		Origin:             "default",
	...
	},
	{
		...
		TriggerSources:     `optional GitHub workflow_run.conclusion == "failure"; chain to qa`,
		Schedule:           "event-only",
		Tools:              "file_read, file_write, shell_exec, mars_harness_cli, grep, record_decision, architecture_audit, harness_doctrine_sync, tool_creation_guard, tool_inventory_audit, git_status, git_diff, git_commit, git_push",
	...
	},
	{
		...
		Domain:             "orchestrator",
		Mode:               "ticket-hygiene",
		TriggerSources:     "schedule; idle chain from engineer",
		Schedule:           "0 7 * * *",
		...
		Guardrails:         "ticket lifecycle, active-plan hygiene, trust, and git discipline",
		ModelRouting:       "fast",
