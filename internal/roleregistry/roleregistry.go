...
var sourceOnlyEntries = []Entry{
	{
		...
		Schedule:           "none",
		Tools:              "file_read, file_write, shell_exec, dependency_sync, mars_harness_cli, grep, workspace_hygiene, github_auth_check, record_decision, ticket_create, tool_create, persona_create, task_trace_summarize, docsync_audit, git_status, git_diff, git_commit, git_push, job_disposition_record, release_orchestrate, github_release_status, git_release_guard",
