...
var defaultEntries = []Entry{
	{
		...
		EscalationBehavior: "return disposition to orchestrator; record blockers in goals, plans, or tickets",
	},
	{
	...
	},
	{
		...
		TriggerSources:     "orchestrator dispatch after planning or architecture review",
		Schedule:           "chain-only",
		...
		EscalationBehavior: "return disposition to orchestrator; create blocker tickets when scope is unclear",
	},
	{
		Role:               "cto-weekly",
		Origin:             "default",
		...
		TriggerSources:     "schedule; orchestrator dispatch after strategy work",
		Schedule:           "0 21 * * 0",
		...
		Guardrails:         "architecture rationale, doctrine sync, docsync, tool policy, trust, and git discipline",
		ModelRouting:       "reasoning",
		ScoringSignals:     "architecture fit, decision quality, plan coherence, audit finding closure",
		EscalationBehavior: "return disposition to orchestrator; record design blockers before ticket creation",
	},
	{
		Role:               "engineer",
		Origin:             "default",
